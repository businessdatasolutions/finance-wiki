...
### Dutch tax / financial-administration compliance

- [[2026-03-01-harding-2026-netherlands-xaf-4-requirements]] — Harding (Invoice Data Extraction, 2026). Vendor explainer on the Dutch **Auditfile Financieel (XAF)**: XAF 4.0 mandatory 2026-01-01 (no backwards compatibility), ~250→~90 data elements, RGS-aligned chart of accounts; the **XAF ≠ SAF-T** correction; five required data categories; ViDA/Peppol positioning. First source in a new NL-compliance cluster. Vendor-sourced.
- [[2026-06-28-perplexity-2026-ontology-agentic-xaf-parser]] — Perplexity AI (LLM-generated answer, 2026). Design sketch for an **ontology-driven agentic XAF parser**: four-layer ontology (syntax/semantic/regulatory/operational), knowledge-graph + agent-orchestration pipeline, XSD+SHACL+business-rules validation, RGS/SBR/NT20 mapping. The engineering-angle complement to the XAF concept. LLM-generated — lowest authority tier.
...
- [[xaf-auditfile-financieel]] — The Netherlands' national digital audit-file standard (Auditfile Financieel); XAF 4.0 mandatory 2026-01-01, RGS-aligned, OECD-SAF-T-independent; reactive on-demand export the Belastingdienst requests during a *boekenonderzoek*. Single-source seed (vendor) opening the NL-compliance cluster.
