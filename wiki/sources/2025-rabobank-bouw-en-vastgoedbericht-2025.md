...
author:
  - "RaboResearch (sector team)"
url: "https://pub.rabobank.nl/bouw---en-vastgoedbericht-2025"
date_published: 2025-09-01
length: "~6 chapters of an online Rabobank publication (Pass 2 — all 6 chapter web-clipper renders ingested: 09 macro, 10 bouwsector, 11 utiliteitsbouw, 12 GWW, 13 installatie, 14 ruw-afbouw; chapter contents short by design (single-page renders); full table from chapter 11 captured separately via PDF)"
venue: "Rabobank (online publication)"
citation_key: "rabobank_2025_bouw_vastgoedbericht"
raw: "../../raw/reports/bouw-vastgoedbericht-2025-09-macro.md (+ 5 sibling chapter files)"
pdf: "../../raw/reports/pub.rabobank.nl_Bouw---en-Vastgoedbericht-2025_09.html.pdf (+ 5 sibling chapter PDFs)"
confidence: 0.75
last_confirmed: 2026-05-25
source_count: 1
accessed_at: 2026-05-25
language: nl
tags: [rabobank, bouw-en-vastgoedbericht, dutch-construction-sectors, woningbouw, utiliteitsbouw, gww, installatiebranche, ruw-afbouw, sector-consolidation, krappe-arbeidsmarkt, werkvoorraad, prefab]
dynamic_capabilities:
  - digital-sensing/scanning-environment
relationships:
  - type: supports
    target: 2025-12-11-rabobank-sectorprognoses-2025-12
    via: "Sectorprognoses gives one-page construction outlook; Bouw publication is the multi-chapter sub-sector deep dive"
  - type: supports
    target: 2025-12-18-rabobank-woningcorporaties-aan-hun-limiet
    via: "Bouw publication house-price + krappe-arbeidsmarkt findings feed into Woningcorporaties implementation context"
  - type: supports
    target: 2026-02-24-rabobank-vastgoed-selectief-investeren
    via: "Both discuss verduurzaming / EPBD pressure on existing stock"
  - type: supports
...
```mermaid
flowchart TB
    subgraph CommonThemes["Themes recurring across all 6 chapters"]
        A[Krappe arbeidsmarkt]
        B[Prefab + robotisering]
        C[Vergrijzing]
        D[Energy transition]
        E[Verduurzaming demand]
        F[ZZP'ers + MKB resilience]
    end

    subgraph Trough["2024-2026 production trough"]
        T1[Nieuwbouw decline]
        T2[Utiliteitsbouw -15% in 2026]
        T3[Permits down]
    end

    subgraph Pivot["Strategic pivot 2026+"]
        P1[Renovatie + verbouw]
        P2[Conceptbouw + standaardisatie]
        P3[Specialist over generalist]
    end
