...
author:
  - "Smit, H.-H."
  - "Dirkse, G."
url: "https://www.rabobank.nl/kennis/d011521158-wat-zijn-de-ondernemerskansen-van-het-beter-benutten-van-bestaande-bebouwing"
date_published: 2026-04-14
length: "~6 pages (Pass 2 — full report read; four utilisation categories enumerated (woningdelen, woningsplitsing, optoppen, transformatie); regeerakkoord positioning, Rabobank financing-product implications)"
venue: "RaboResearch"
citation_key: "rabobank_2026_beter_benutten"
raw: "../../raw/reports/rabobank-2026-04-beter-benutten-bestaande-bebouwing.md"
pdf: "../../raw/reports/Wat zijn de ondernemerskansen van het beter...pdf"
confidence: 0.80
last_confirmed: 2026-05-25
source_count: 1
accessed_at: 2026-05-25
language: nl
tags: [rabobank, raboresearch, dutch-housing, beter-benutten, woningdelen, woningsplitsing, optoppen, transformatie, renovatie, woningbouwstrategie, sft-stimuleringsregeling, hospitaregeling]
dynamic_capabilities:
  - digital-sensing/scanning-environment
  - digital-seizing/balancing-digital-portfolios
relationships:
  - type: supports
    target: 2025-12-18-rabobank-woningcorporaties-aan-hun-limiet
    via: "Same problem (housing shortage), different sides — corporaties financing pressure ↔ construction-firm strategy pivot"
  - type: supports
    target: 2025-12-11-rabobank-sectorprognoses-2025-12
    via: "Construction-sector outlook context (personnel shortage, declining permits) is the backdrop driving the beter-benutten pivot"
  - type: supports
    target: 2026-02-24-rabobank-vastgoed-selectief-investeren
    via: "Both discuss brownfield / renovation-over-nieuwbouw shift; Vastgoed 2026 from investor perspective, this from construction-firm perspective"
  - type: supports
...
```mermaid
flowchart TB
    BB[Beter benutten van bestaande bebouwing]

    BB --> C1[1. Woningdelen<br/>meer huishoudens onder één dak]
    BB --> C2[2. Woningsplitsing<br/>één woning → meerdere]
    BB --> C3[3. Optoppen<br/>extra woonlagen toevoegen]
    BB --> C4[4. Transformatie<br/>niet-woon → woon]

    C1 --> I1[Friendscontracten<br/>Hospitaregeling]
    C2 --> I2[Splitsgids VRO<br/>Subsidies Gelderland + Drenthe]
    C3 --> I3[SFT-regeling 2025+<br/>Rijk: 100k dwellings to 2030]
    C4 --> I4[SFT-regeling 2025+<br/>kantoren/winkels conversie]
```
