...
length: "~19 pages (Pass 2 — full read: macro outlook, all 9 sector sub-chapters (agriculture, industry, construction, trade, hospitality, transport, information+communication, business services, healthcare), all 9+ figures referenced; figure thumbnails in raw markdown collapsed)"
venue: "RaboResearch"
citation_key: "rabobank_2025_sectorprognoses_dec"
raw: "../../raw/reports/rabobank-2025-12-sectorprognoses.md"
pdf: "../../raw/reports/Sectorprognoses december 2025_ van hardnekkige....pdf"
confidence: 0.80
last_confirmed: 2026-05-25
source_count: 1
accessed_at: 2026-05-25
language: nl
tags: [rabobank, raboresearch, sector-forecast, netherlands, dutch-economy, gva, agriculture, industry, construction, retail, hospitality, healthcare, ict-sector, business-services, ai-adoption, personnel-shortage, netcongestion, nitrogen]
...
relationships:
  - type: supports
    ...
    via: "Sectorprognoses construction-sector outlook is the macro context for Woningcorporaties pressure narrative"
  - type: supports
    target: 2026-02-24-rabobank-vastgoed-selectief-investeren
    via: "Provides macro-sector context for the Vastgoed 2026 outlook two months later"
  - type: supports
    target: 2026-04-14-rabobank-beter-benutten-bestaande-bebouwing
    via: "Construction-sector personnel + permit constraints are the backdrop for the better-utilising-existing-buildings argument"
  - type: supports
...
```mermaid
flowchart TB
    Coalition["Nieuwe coalitie 2026–2030"]

    Coalition --> Agri["Agriculture<br/>buy-out schemes intensify<br/>→ −5% cattle complex 2026"]
    Coalition --> Care["Healthcare<br/>spending growth slowed<br/>by D66/CDA preventive plan"]
    Coalition --> Def["Defence ↑<br/>→ Industry innovation impulse<br/>(VDL Nedcar, Leiden Bio)"]
    Coalition --> Build["Construction<br/>depends on:<br/>nitrogen policy speed<br/>grid congestion solutions<br/>housing-shortage action"]
    Coalition --> Trade["Trade<br/>youth minimum wage 2027<br/>→ retail margin compression"]
    Coalition --> Hospo["Hospitality<br/>VAT lodging 2026 + youth wage 2027<br/>→ margin double-hit"]
```
