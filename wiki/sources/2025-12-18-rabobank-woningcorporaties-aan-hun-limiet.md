...
length: "~5 pages (Pass 2 — full report read, single figure interpreted, all five In-het-kort bullets transcribed, Regiewet + ATAD + Vpb mechanics traced through)"
venue: "RaboResearch"
citation_key: "rabobank_2025_woningcorporaties_limiet"
raw: "../../raw/reports/rabobank-2025-12-woningcorporaties-aan-hun-limiet.md"
pdf: "../../raw/reports/Woningcorporaties aan hun limiet_...pdf"
confidence: 0.85
last_confirmed: 2026-05-25
source_count: 1
accessed_at: 2026-05-25
language: nl
tags: [rabobank, raboresearch, woningcorporaties, dutch-housing, sectoral-financial-distress, wsw, atad, vennootschapsbelasting, regiewet, social-housing, woningtekort, prestatieafspraken]
...
relationships:
  - type: supports
    ...
    via: "Same author institution and publication month; Sectorprognoses macro-construction outlook is the systemic context"
  - type: supports
    target: 2026-02-24-rabobank-vastgoed-selectief-investeren
    via: "Vastgoed 2026 cites 'corporaties missen investeringsruimte' — this report is the canonical reference for that claim"
  - type: supports
    target: 2026-04-14-rabobank-beter-benutten-bestaande-bebouwing
    via: "Same problem (housing shortage), opposite sides — Beter benutten proposes supply-side solution, Woningcorporaties exposes financing bottleneck"
  - type: supports
...
```mermaid
flowchart TB
    A[Rising bouwkosten] --> X[Squeezed investment capacity]
    B[Higher interest rates] --> X
    C[Stricter huurregulering] --> X
    D[Vpb burden 700M → 1.5B/yr] --> X
    E[ATAD interest-deductibility cap] --> X
    F[Verduurzaming verplichtingen] --> X

    X --> Y[WSW guarantee volume > €100B]
    X --> Z[Reduced investment ↓]

    Z --> M[Stagnation in nieuwbouw]
    Z --> N[Stagnation in verduurzaming]
    Z --> O[Woningtekort → 420k in 2026]

    M --> P[Gemeenten + ontwikkelaars vast]
    N --> Q[Klimaatdoelen gemist]
    O --> R[Nationale Prestatieafspraken in gevaar]
```
