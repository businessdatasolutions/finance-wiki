...
Usage:
    python fetch_zotero.py --collection finance-wiki
    python fetch_zotero.py --collection "State of AI" --dry-run
    python fetch_zotero.py -c finance-wiki --limit 3 --json
...
def main() -> int:
    ...
    ap.add_argument("-c", "--collection", default="finance-wiki", help="Zotero collection name (default: finance-wiki)")
